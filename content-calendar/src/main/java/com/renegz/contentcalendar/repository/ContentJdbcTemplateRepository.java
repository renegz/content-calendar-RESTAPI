...
//Esto es el jdbc el cual es un buen inicio para la comunicacion con la base de datos desde java, sin embargo es mejor Spring Data
//Para ocupar esto, solo debemos sustituir el otro repositorio por este
@Repository
